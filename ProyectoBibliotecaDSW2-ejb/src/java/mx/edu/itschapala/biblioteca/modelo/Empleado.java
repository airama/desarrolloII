...
public class Empleado implements Serializable {
    ...
    public Empleado(Integer idEmpleado, String nombre, String apellidoPaterno, String telefono, Character sexo, String direccion, String colonia, String estado, int codigoPostal) {
        this.idEmpleado = idEmpleado;
        this.nombre = nombre;
    ...
    public String toString() {
        return "mx.edu.itschapala.biblioteca.Empleado[ idEmpleado=" + idEmpleado + " ]";
    }
